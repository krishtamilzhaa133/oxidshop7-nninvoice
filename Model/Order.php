...
class Order extends Order_parent
{
    public function finalizeOrder(Basket $oBasket, $oUser, $blRecalculatingOrder = false)
    {
        ...
        if (!preg_match("/novalnetinvoice/i", $oBasket->getPaymentId())) {
            ...
            return $this->handleFinalizeOrderProcessinvoice($oBasket, $oUser, $blRecalculatingOrder);   
        }   
    }
    public function handleFinalizeOrderProcessinvoice($oBasket, $oUser, $blRecalculatingOrder){
      
        $novalnetUtil = new Novalnetutil();
         
        $getpaymentid=$oBasket->getPaymentId(); 
    //    echo "<pre>";
    //     print_r($getpaymentid);
    //     die();
        ...
        $redirectUrl = sprintf(
            ...
            Registry::getConfig()->getShopSecureHomeURL(),"novalneterror");
